...
us_states <- ne_states(country = "United States of America",
                       returnclass = "sf")
ca_states <- ne_states(country = "Canada",
                             returnclass = "sf")

# Combine both
NA_states <- bind_rows(us_states, ca_states)
...
``` r
NA_states_crop <- st_crop(NA_states, bbox_buf)
```
...
```
    ...
    ## Ncells  3640374 194.5    5308168  283.5         NA   5308168  283.5
    ## Vcells 56897751 434.1  171593824 1309.2      32768 169591461 1293.9
...
![](Sample_Map_files/figure-gfm/customizing_map-1.png)<!-- -->
...
```
    ...
    ## [15] prettyunits_1.2.0             classInt_0.4-11              
    ## [17] curl_7.0.0                    RColorBrewer_1.1-3           
    ## [19] KernSmooth_2.23-26            withr_3.0.2                  
    ## [21] e1071_1.7-17                  progressr_0.18.0             
    ## [23] cli_3.6.5                     rmarkdown_2.30               
    ## [25] crayon_1.5.3                  ragg_1.5.1                   
    ## [27] generics_0.1.4                otel_0.2.0                   
    ## [29] rstudioapi_0.18.0             httr_1.4.8                   
    ## [31] tzdb_0.5.0                    DBI_1.3.0                    
    ## [33] proxy_0.4-29                  slippymath_0.3.1             
    ## [35] cellranger_1.1.0              vctrs_0.7.1                  
    ## [37] hms_1.1.4                     systemfonts_1.3.2            
    ## [39] units_1.0-0                   rnaturalearthhires_1.0.0.9000
    ## [41] glue_1.8.0                    codetools_0.2-20             
    ## [43] stringi_1.8.7                 pillar_1.11.1                
    ## [45] htmltools_0.5.9               R6_2.6.1                     
    ## [47] textshaping_1.0.5             evaluate_1.0.5               
    ## [49] lattice_0.22-9                class_7.3-23                 
    ## [51] Rcpp_1.1.1                    xfun_0.56                    
    ## [53] pkgconfig_2.0.3
